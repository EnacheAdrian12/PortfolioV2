...
const CopyTesla = () => {
  return (
    <div className="teslaFont">
      <div className="bg-[url('./projectsImages/tesla1.avif')] bg-cover bg-center h-screen ">
      ...
      {/* Model Y */}
      <div className="bg-[url('./projectsImages/tesla2.avif')] bg-cover bg-center h-screen">
      ...
      {/* Model S */}
      <div className="bg-[url('./projectsImages/tesla3.avif')] bg-cover bg-center h-screen">
        <div className="flex flex-col justify-center pt-28">
      ...
      {/* Model X */}
      <div className="bg-[url('./projectsImages/tesla4.avif')] bg-cover bg-center h-screen">
        <div className="flex flex-col justify-center pt-28">
      ...
      {/* Solar Panels */}
      <div className="bg-[url('./projectsImages/tesla5.avif')] bg-cover bg-center h-screen">
        <div className="flex flex-col justify-center pt-28">
      ...
      {/* Solar Roof */}
      <div className="bg-[url('./projectsImages/tesla6.avif')] bg-cover bg-center h-screen">
        <div className="flex flex-col justify-center pt-28">
      ...
      {/* Accessories */}
      <div className="bg-[url('./projectsImages/tesla7.avif')] bg-cover bg-center h-screen">
        <div className="flex flex-col justify-center pt-28">
          <h1 className="text-[40px] m-auto font-bold text-dark">
            Accessories
          </h1>
