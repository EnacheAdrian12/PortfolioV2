...
const ToDoListLogic = () => {
  ...
  return (
    <div className=" bg-slate-700 flex justify-center h-screen w-screen">
      <div className="   h-44 mt-40 w-[30rem]">
        <h1 className="md:text-6xl font-mono bg-slate-700 font-bold text-white text-center  text-5xl">
          To Do List
        </h1>
        <div className="mt-8 mx-4  md:mx-0 ">
          <h1 className="md:text-xl font-mono  font-bold text-slate-500 text-center text-lg">
            Add new todo...{" "}
          </h1>
          <form>
            <input
        ...
        {list.length > 0 ? (
          <button
            className="flex-shrink-0 font-mono bg-slate-600 hover:bg-slate-400 border-slate-600 hover:border-slate-400 text-sm border-4 text-white py-1 px-2 rounded w-24  mt-2 mb-10 md:mx-0 mx-4"
            onClick={() => deleteAll()}
          >
            Clear
          </button>
